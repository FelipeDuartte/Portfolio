          ...
          <div>
            <p className="d-flex m-0 position-relative justify-content-center text-white meu-nome-e">
              <span className="background-opa">
                Hey! <span className="bi bi-emoji-wink-fill" />
              </span>
              , my name is
            </p>
            <div>
            ...
            <nav className="col d-flex align-items-center justify-content-center">
              ...
              >
                <span className="bi bi-github me-3" id="icons-glt" />
              </a>
              <a
                href="#"
                ...
                rel="noopener noreferrer"
              >
                <span className="bi bi-linkedin me-3" id="icons-glt" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <span className="bi bi-tiktok" id="icons-glt" />
              </a>
            </nav>
